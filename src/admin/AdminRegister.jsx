...
export default function AdminRegister() {
    ...
    const PostAdminRegister = (obj) => {
        return axios.post(`https://mirsat-vercel-database.vercel.app/AdimnRegisterYoox`, obj)
    }
        ...
        return (
            <div className='register-main-con'>
                ...
                <div className='register-1st-con'>
                    ...
                    <p className='register-text'>ADMIN REGISTRATION</p>
                ...
                <div className='register-2nd-container'>
                    <p style={{ marginTop: '50px' }}>ADMIN REGISTER WITH YOUR SOCIAL MEDIA ACCOUNT</p>
